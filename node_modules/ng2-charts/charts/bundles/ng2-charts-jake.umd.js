(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ng2-charts-jake.umd"] = factory(require("@angular/core"));
	else
		root["ng2-charts-jake.umd"] = factory(root["@angular/core"]);
...
var BaseChartDirective = (function () {
    ...
    BaseChartDirective.prototype.reInit = function () {
        this.ctx = this.element.nativeElement.getContext('2d');
        this.cvs = this.element.nativeElement;
        this.initFlag = true;
        if (this.data || this.datasets) {
    ...
    BaseChartDirective.prototype.getDatasets = function () {
        ...
        if (this.datasets && this.datasets.length ||
            ...
            datasets = (this.datasets /*|| datasets*/)  // thursday march 2 2017 - editing to test
...
//# sourceMappingURL=ng2-charts-jake.umd.js.map